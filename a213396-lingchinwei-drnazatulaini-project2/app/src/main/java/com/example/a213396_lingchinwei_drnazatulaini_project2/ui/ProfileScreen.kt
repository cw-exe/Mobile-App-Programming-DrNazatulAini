        ...
        Column(
            ...
            Box(
                ...
                Column(verticalArrangement = Arrangement.spacedBy(6.dp)) {
                    ...
                    Text(
                        text     = "SDG 4 — Your courage to learn today becomes someone else's path tomorrow.",
                        fontSize = 13.sp,
                        color    = AtlasSky
                    )
                }
...
fun JourneyStatsCard(couragePoints: Int, sessionsCompleted: Int, chainDepth: Int) {
    // Warm gold tint echoes the Courage Points fire icon inside — small but cohesive touch
    Card(
        modifier  = Modifier.fillMaxWidth(),
        shape     = RoundedCornerShape(16.dp),
