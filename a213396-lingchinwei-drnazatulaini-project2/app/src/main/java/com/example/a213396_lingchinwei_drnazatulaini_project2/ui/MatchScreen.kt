        ...
        Column(
            ...
            Box(
                ...
                Column(verticalArrangement = Arrangement.spacedBy(6.dp)) {
                    ...
                    Text(
                        text     = "SDG 4 — Free, verified peer tutors. No student left without support.",
                        fontSize = 13.sp,
                        color    = AtlasSky
                    )
                }
...
fun VolunteerCard(volunteer: Volunteer, isBooked: Boolean, onBookSession: () -> Unit) {
    ...
    // Tint based on volunteer's primary subject — same color family as the subject chips below
    Card(
        modifier  = Modifier
            .fillMaxWidth()
        ...
        colors    = CardDefaults.cardColors(containerColor = getSubjectColor(volunteer.subjects.firstOrNull() ?: "").copy(alpha = 0.15f)),
